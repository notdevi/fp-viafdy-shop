        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan Anda sudah sukses dicheckout, selanjutnya untuk pembayaran silahkan transfer <br> ke rekening <strong>Bank BRI Nomor Rekening : 1234-5678-91011</strong> dengan nominal : <strong>Rp. {{ number_format($pesanan->kode+$pesanan->jumlah_harga) }}</strong></h5>
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    <img class="card-img-top" src="{{ url('images') }}/{{ $pesanan_detail->barang->gambar }}" width="100" alt="...">
                                </td>
